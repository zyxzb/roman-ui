    ...
    useEffect(() => {
        tlHero.current = gsap.timeline({
            scrollTrigger: {
                ...
                // first top - trigger, second top - viewport
                start: 'top top',
                scrub: 1
            }
        });
        ...
        gsap.fromTo(article1.current.children, {x: '-=150%', autoAlpha: 0, duration: 1, ease: 'power3'}, {x: '+=150%', autoAlpha: 1, scrollTrigger: {
            trigger: image1.current,
            start: 'bottom bottom'
        }})
        gsap.fromTo(article2.current.children, {x: '+=150%', autoAlpha: 0, duration: 1, ease: 'power3'}, {x: '-=150%', autoAlpha: 1, scrollTrigger: {
            trigger: image2.current,
            start: 'bottom bottom'
        }})
        gsap.fromTo(image1.current, {x: '-=150%', autoAlpha: 0, duration: 1, ease: 'power3'}, {x: '+=150%', autoAlpha: 1, scrollTrigger: {
            trigger: image1.current,
            start: 'bottom bottom'
        }})
        gsap.fromTo(image2.current, {x: '+=150%', autoAlpha: 0, duration: 1, ease: 'power3'}, {x: '-=150%', autoAlpha: 1, scrollTrigger: {
            trigger: image2.current,
            start: 'bottom bottom'
        }})
