...
const AnimatedSvg = () => {
  ...
  useEffect(() => {
    ...
    .to(power, {duration: 0.5, fill:'#00d55c'})
    .to(cursor, {duration: 0.5, x: '-=250', y: '-=25'}, '+=0.3')
    .set(linearFirst, {scaleY: 0, transformOrigin: '0 0'})
    .set(scaleElements, {scale: 0.4, transformOrigin: '0 0'})
    .to(linearFirst, {duration: 1, autoAlpha: 1, scaleY: 1, transformOrigin: '0 0'})
    .to(greenBrick, {duration: 0.4, autoAlpha: 1}, '-=0.5')
    .to(scaleElements, {duration: 0.4, autoAlpha:1})
    .to(greenBrickShadow, {duration: 1, autoAlpha: 1}, '-=0.3')
    .to(linearSecond, {duration: 0.4, autoAlpha: 1})
    .to(scaleElements, {duration: 1.2, scale: 1})
    .to(violetBrick, {duration: 0.4, autoAlpha: 1})
    .to(violetBrickShadow, {duration: 0.6, autoAlpha: 1}, '-=0.3')
    .to(linearThird, {duration: 0.5, autoAlpha: 1})
    .fromTo(window, {duration: 1, autoAlpha: 0, x: '-=50'}, {autoAlpha: 1, x: '+=50'})
    .fromTo(windowInnerElements, {duration: 1, autoAlpha: 0, x: '-=30'}, {autoAlpha: 1, x: '+=30'}, '+=0.3')
    .fromTo(arrow3Dots, {duration: 1.2, autoAlpha: 0, x: '-=50', y: '+=20'}, {autoAlpha:1, x: '+=50', y: '-=20', stagger:0.2})
    .fromTo(listRight[0], {duration: 0.4, autoAlpha: 0, x: '+=20', y: '-=20'}, {autoAlpha: 1, x: '-=20', y: '+=20'}, '-=0.1')
    .fromTo(listRight[1], {duration: 0.4, autoAlpha: 0, x: '-=50', y: '+=20'}, {autoAlpha: 1, x: '+=50', y: '-=20'}, '-=0.1')
    .fromTo(listRight[2], {duration: 0.4, autoAlpha: 0, x: '-=30', y: '+=20'}, {autoAlpha: 1, x: '+=30', y: '-=20'}, '-=0.1')
    .fromTo(listRight[3], {duration: 0.4, autoAlpha: 0, x: '+=50', y: '+=50'}, {autoAlpha: 1, x: '-=50', y: '-=50'}, '-=0.1')
    .fromTo(listRight[4], {duration: 0.4, autoAlpha: 0, x: '-=25', y: '+=40'}, {autoAlpha: 1, x: '+=25', y: '-=40'}, '-=0.1')
    .fromTo(listRight[5], {duration: 0.4, autoAlpha: 0, x: '+=200', y: '-=100'}, {autoAlpha: 1, x: '-=200', y: '+=100'}, '-=0.1')
    .to(listShadow, {duration: 2, autoAlpha:1}, '-=1.5')
    .fromTo(logo, {duration: 2, autoAlpha: 0, x: '+=200', y: '-=100'}, { autoAlpha: 1, x: '-=200', y: '+=100'}, '-=0.5')
